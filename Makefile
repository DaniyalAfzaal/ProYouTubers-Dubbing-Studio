...
install-dep:
	...
	cd apps/backend/services/tts/models/chatterboxModel && echo "=== Syncing chatterboxModel ===" && uv sync --upgrade && echo "=== chatterboxModel sync complete ==="
	@cd apps/backend/services/tts/models/edgeTTsModel && uv sync
